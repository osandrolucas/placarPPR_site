 ...
 *  
 *  Alterações realizadas por hugo.constantinopolos para atender
 *  as necessidades do site.
 *
 */
!function($){
	$.fn.extend({
		goalProgress: function(options) {
			...
			return this.each(function(){
				...
				// Generate the HTML
 				var progressBar = '<div class="progressBar" style="background:'+defaults.color+';border-radius:'+defaults.progressRadius+';">' + defaults.textBefore + defaults.textAfter + '</div>';
